...
class TestLoadModel(unittest.TestCase):
    ...
    def test_infer(self):
        pretrain_path, ckpt_path, label_scaler = try_download_predefined_checkpoint(
            checkpoint="ra4-rsr1_DeepPavlov-rubert-base-cased_cls.pth.tar",
            dir_to_download=utils.TEST_OUT_DIR)
    ...
    @staticmethod
    def infer_bert(pretrain_path, labels_scaler, output_file_gzip, ckpt_source=None, pooler='cls',
        ...
        model = BertOpenNREInferencePipelineItem.init_bert_model(
            pretrain_path=pretrain_path, labels_scaler=labels_scaler, ckpt_path=ckpt_source,
